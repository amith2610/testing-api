...
class Emp(Resource):
    def get(self):
        ...
        parser.add_argument('empno',type=int,required=True,help="emp no. cannot be left blank!")
    ...
    def post(self):
        parser=reqparse.RequestParser()
        parser.add_argument('empno',type=int,required=True,help="emp no. cannot be left blank!")
        parser.add_argument('ename',type=str,required=True,help="emp name cannot be left blank!")
        ...
        parser.add_argument('hiredate',type=str,required=True,help="hire date cannot be left blank!")
        parser.add_argument('sal',type=str,required=True,help="salary cannot be left blank!")
        parser.add_argument('comm',type=str)
        parser.add_argument('deptno',type=int,required=True,help="dept no cannot be left blank!")
        ...
        try:
            ...
            if len(x)>0: return {"message":"An emp with that number already exists"},400
        except:
        ...
        if (data['comm']!=None):
            ...
            try:
                ...
                return{"message":"There was an error inserting the values"}
